...
public class AddSale extends JFrame {
    ...
    private void addButtonActionPerformed(ActionEvent e) {
        ...
        Operations.addSale(this,product,ID,quantity,date);
    }
    ...
    private void comboBoxesInit(){
        ...
        clientIDList=Operations.readClientID(this);
        ProductsList = Operations.readProducts(this);
    ...
    private void productComboItemStateChanged(ItemEvent e) {
        int quantity=Operations.getQuantityProduct(this,productCombo.getSelectedItem().toString());
